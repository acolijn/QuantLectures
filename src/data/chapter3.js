const chapter3 = {
  ...
  "formulas": [
    {
      "latex": "\\sum_{j} P(j) = 1",
      "name": "Normering (discreet)"
    },
    {
      "latex": "\\langle j \\rangle = \\sum_{j} j\\, P(j)",
      "name": "Verwachtingswaarde (discreet)"
    },
    {
      "latex": "\\langle f(j) \\rangle = \\sum_{j} f(j)\\, P(j)",
      "name": "Verwachtingswaarde van $f(j)$"
    },
    {
      "latex": "\\sigma^2 = \\langle j^2 \\rangle - \\langle j \\rangle^2",
      "name": "Variantie (discreet)"
    },
    {
      "latex": "\\sigma = \\sqrt{\\langle j^2 \\rangle - \\langle j \\rangle^2}",
      "name": "Standaardafwijking"
    },
    {
      "latex": "\\int_{-\\infty}^{\\infty} \\rho(x)\\, dx = 1",
      "name": "Normering (continu)"
    },
    {
      "latex": "\\langle x \\rangle = \\int_{-\\infty}^{\\infty} x\\, \\rho(x)\\, dx",
      "name": "Verwachtingswaarde (continu)"
    },
    {
      "latex": "\\langle f(x) \\rangle = \\int_{-\\infty}^{\\infty} f(x)\\, \\rho(x)\\, dx",
      "name": "Verwachtingswaarde van $f(x)$"
    },
    {
      "latex": "\\sigma^2 = \\langle x^2 \\rangle - \\langle x \\rangle^2",
      "name": "Variantie (continu)"
    }
  ],
  "concepts": [
    {
